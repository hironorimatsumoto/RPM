...
print_wvsw_to_fig = false;  % >> PLOT WAVE EROSION AND WEATHERING CONTRIBUTION FIGURE
print_wvsw_to_txt = false;  % >> WRITE WAVE EROSION AND WEATHERING CONTRIBUTION INTO A TEXT FILE
...
print_pcom_to_jpg = true;   % >> PLOT FINAL MODELLED PROFILE FIGURE 
                    ...
                    %for we=1:length(wav_erodi)
                        ...
                        for h=1:length(height_values)
                            ...
                            for resi=1:length(resi_values)
                                ...
                                f_name = ['IPA', num2str(i_angle), '-MTR', num2str(tidal_values(tr)),'-WEC',num2str(wt_const),'-FW',num2str(height_values(h)),'-FR',num2str(resi_values(resi))];
                        ...
                        if(print_wvsw_to_txt)
                            ...
                            filename=[output_path, f_name, '-wave_vs_wea.txt'];
                        ...
                        if(print_pcom_to_jpg)
                            ...
                            %filename=[output_path, f_name, '.jpg'];
                            %saveas(gcf, filename);
                            %hold off;
                            %close;
