%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    sttri_brok_p_distri_v1.m
%    Copyright (c) 2017 Hironori Matsumoto
%    This software is released under the MIT License.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [sstri_p_bro, sstri_p_bro_sub, sstri_bro_dist1, sstri_bro_dist2] = sstri_brok_p_distri_v1(range,FH,UD)
    
    clear sstri_p_bro sstri_p_bro_sub sstri_bro_dist1 sstri_bro_dist2
    range=ceil(range);
    sstri_p_bro = zeros(size(range,2),max(range)+1);
